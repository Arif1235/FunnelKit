...
if ( ! class_exists( '\FKCart\Includes\Front' ) ) {
	class Front {
		...
		public function get_shipping_total( $raw = false ) {
			...
			return false === $raw ? wc_price( $shipping_total ) : $shipping_total;
		}

		/**
		 * Get final total including shipping and taxes
		 *
		 * @param bool $raw
		 *
		 * @return float|string
		...
		public function get_total( $raw = false ) {
			...
			return false === $raw ? wc_price( $total ) : $total;
		}
